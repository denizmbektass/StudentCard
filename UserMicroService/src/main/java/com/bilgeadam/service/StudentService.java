...
public class StudentService extends ServiceManager<Student, String> {
    ...
    public SaveStudentResponseDto save(SaveStudentRequestDto dto) {
        ...
        save(student);
        return IUserMapper.INSTANCE.toStudentResponseDto(student);
    }
    ...
    public List<FindByGroupNameResponseDto> findByGroupNameList(String groupName) {
        return IUserMapper.INSTANCE.toFindByGroupNameListResponseDto(studentRepository.findByGroupNameListIgnoreCase(groupName));
    }
    ...
    public String registerManagerForStudent(RegisterRequestDto dto) {
        Student student = IUserMapper.INSTANCE.toStudentFromRegisterRequestDto(dto);
