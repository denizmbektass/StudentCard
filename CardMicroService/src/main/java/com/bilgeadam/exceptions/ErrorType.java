...
public enum ErrorType {
    ...
    STATUS_NOT_ACTIVE(4003,"User status is not active, please reset your password first to make it active",HttpStatus.BAD_REQUEST),
    ...
    ROLE_MISMATCH(500,"Role eslestirilemedi",HttpStatus.BAD_REQUEST),
