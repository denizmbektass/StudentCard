...
public enum ErrorType {
    ...
    TOTAL_WEIGHTS_VALIDATE(9034,"Toplam ağırlık 100'e eşit olmalıdır.", HttpStatus.BAD_REQUEST),
    TOTAL_WEIGHTS_FORMAT(9035,"Hatalı ağırlık formatı.Lütfen İşleminizi kontrol ediniz.", HttpStatus.BAD_REQUEST);
